package com.encuestas.registro.controller;


import com.encuestas.registro.dto.AuthDTO.JwtResponse;
import com.encuestas.registro.dto.AuthDTO.LoginRequest;
import com.encuestas.registro.dto.AuthDTO.MessageResponse;
import com.encuestas.registro.dto.AuthDTO.SignupRequest;
import com.encuestas.registro.model.Rol;
import com.encuestas.registro.model.Usuario;
import com.encuestas.registro.repository.RolRepository;
import com.encuestas.registro.repository.UsuarioRepository;
import com.encuestas.registro.security.JwtUtils;
        ...
        if (strRoles == null) {
            ...
            strRoles.forEach(role -> {
                ...
                case "admin":
                    ...
                    break;
                case "usuario":
                    Rol docRol = rolRepository.findByNombre(Rol.NombreRol.ROL_USUARIO)
                            .orElseThrow(() -> new RuntimeException("Error: Rol no encontrado."));
                    roles.add(docRol);
                    break;
                default:
                    Rol usuariRol = rolRepository.findByNombre(Rol.NombreRol.ROL_USUARIO)
                            .orElseThrow(() -> new RuntimeException("Error: Rol no encontrado."));
                    roles.add(usuariRol);
                }
            });
